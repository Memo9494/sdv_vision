...
class Yolov8Node(Node):
    ...
    def __init__(self) -> None:
        ...
        # params
        self.declare_parameter("model", "/ws/src/yolov8n.pt")
        ...
        # topcis
        #crear un publisher de tipo objectDetection, este mensaje es de tipo 

        self._pub = self.create_publisher(Detection2DArray, "detections_memo", 10)
        self._dbg_pub = self.create_publisher(Image, "dbg_image1_memo", 10)
